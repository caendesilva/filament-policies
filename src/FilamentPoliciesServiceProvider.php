...
class FilamentPoliciesServiceProvider extends PackageServiceProvider
{
    public static string $name = 'filament-policies';

    public static string $viewNamespace = 'filament-policies';
    ...
    {
        return 'desilva/filament-policies';
    }
